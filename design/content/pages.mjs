...
export const home = {
    ...
    // Photo mosaic of every service under the hero.
    mosaic: {
      ...
      blurbs: {
        ...
        tyre: 'Renkaanvaihto tai rengashotelli ilman jonottamista.',
        wash: 'Pesu tai detailing työpäiväsi aikana.',
        pickupReturn: 'Nouto sovitusta paikasta ja palautus myöhemmin.',
        glass: 'Ajokuntoinen auto lasi- tai korikorjaamoon.',
        dealer: 'Dokumentoitu luovutus autoliikkeelle tai leasingyhtiölle.',
        business: 'Toistuvat siirrot ja huoltoajot yhdellä sopimuksella.',
      },
    },
  ...
  en: {
    ...
    mosaic: {
      ...
      blurbs: {
        ...
        tyre: 'A tyre change or tyre hotel visit without the queue.',
        wash: 'A wash or detailing during your working day.',
        pickupReturn: 'Collected from the agreed place and returned later.',
        glass: 'A roadworthy car to the glass or body shop.',
        dealer: 'A documented handover to the dealer or leasing company.',
        business: 'Recurring moves and service runs under one agreement.',
      },
    },
